                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <h3>{{ __('Nieuw wachtwoord aanvragen') }}</h3>
                            <small>Ga na het versturen naar uw email om het wachtwoord te herstellen</small>
                        </div>
                        <form role="form" method="POST" action="{{route('resetPassword')}}">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary my-4">{{ __('Stuur Email') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
